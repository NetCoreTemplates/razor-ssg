...
Then saving the domain name to `/wwwroot/CNAME`, e.g:
...
Whilst still only at **v1** release, we found it already had a number of advantages over our existing Jekyll static website:

 - Faster live reloads
 - C#/Razor more type-save & productive than Ruby/Liquid
 - Better flexibility to implement new features
 - Better IDE support (from Rider)
 - Ability to reuse our extensive .NET libraries
 - Better development experience

The last point ultimately prompted us to seek an alternative solution as we were previously using Jekyll from Windows/WSL which 
made it awkward to manage the code-base and assets from a different filesystem and upgrading to the latest Jekyll broke our 
RubyMine support forcing us to using text editors to manage.
...
letting us adopt our preferred approach to [Simple, Modern JavaScript](https://vue-mjs.web-templates.io/posts/javascript)
without any build-tooling or SPA complexity.

We're very pleased with the results of [https://servicestack.net](https://servicestack.net) new Razor SSG generated website
whose source code is being publicly maintained at:

- [https://github.com/servicestack/servicestack.net](https://github.com/servicestack/servicestack.net)

Which serves as a good example at how well this template scales for larger websites which only needed one new
Markdown feature to display our growing video library:
...
In future we'll look at expanding this template with generic Markdown features, or maintain a shared community collection
of Markdown features if there ends up being a community contribution of new features.
